 ...
 */
public class Main {	
	Student bob = new StudentSectionFactory().createStudent("1", "Bob");
	Student tim = new StudentSectionFactory().createStudent("2", "Tim");
	Student allen = new StudentSectionFactory().createStudent("3", "Allen");
	Student[] students = {bob, tim, allen};
	Section bio1 = new StudentSectionFactory().createSection(1, "Biology");
	Section bio2 = new StudentSectionFactory().createSection(2, "Biology");
	Section math = new StudentSectionFactory().createSection(3, "Mathematics");
	...
	private void readDataFromDb() {
		...
		*/
		 ...
		 new StudentSectionFactory().newTranscriptEntry(bob,bio1,"A");
		 new StudentSectionFactory().newTranscriptEntry(bob,math,"B");
		 new StudentSectionFactory().newTranscriptEntry(tim,bio1,"B+");
		 new StudentSectionFactory().newTranscriptEntry(tim,math,"A-");
		 new StudentSectionFactory().newTranscriptEntry(allen,math,"B");
		 new StudentSectionFactory().newTranscriptEntry(allen,bio2,"B+");
